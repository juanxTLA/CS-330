...
run.Astar        <- TRUE  # Run A* pathfinding
...
file.path  <- c("C:/Users/mpetty/Desktop/Working, CS 330/", "C:/Users/jpinckard/Desktop/Working, CS 330/")[computer]
...
write.text(trace.file, paste("CS 330, Pathfinding, End", Sys.time(), "\n"))
