...
# Purpose:  Plot movement trajectories generated by Dynamic movement.
...
steering.names  <- c("Continue", "Stop",   "Align",   "Face target", "Face movement", "Seek",            "Flee",
                     "Arrive",   "Pursue", "Wander", "Follow path", "Separate",      "Avoid collision", "Swirl")
...
if (animate) {
  ...
  cat("animate=", animate, "stop.time=", stop.time, "delta.time=", delta.time, "frames= all", "\n")
