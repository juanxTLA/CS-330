...
scenario <- 16       # Scenario to execute
...
source(paste(source.path, "CS 330, Dynamic movement, 2 Initialize v8.r", sep=""))
...
source(paste(source.path, "CS 330, Dynamic movement, 4 Plot v11.r", sep=""))
